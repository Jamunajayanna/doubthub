    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4 py-12">
      <div className="max-w-md w-full bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200 p-10 border border-slate-100">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-black text-slate-900 mb-2">Join the Club</h2>
          <p className="text-slate-500 font-medium">Become part of the most helpful community</p>
        </div>
